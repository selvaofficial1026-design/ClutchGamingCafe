...
export default function PrivacyPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col pt-32 bg-[#080C14] text-white relative overflow-hidden">
      ...
      <section className="px-4 sm:px-6 md:px-12 py-12 sm:py-16 md:py-20 max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-slate-400 mt-6 sm:mt-8">
        ...
        <div className="space-y-8 sm:space-y-12">
          ...
          <motion.div 
            ...
            className="prose prose-stone max-w-none text-slate-300 font-light text-sm sm:text-base md:text-lg leading-relaxed text-center max-w-3xl mx-auto mb-10 sm:mb-16 md:mb-20"
          >
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            {policies.map((policy, index) => (
              <motion.div
                ...
                className="group bg-[#0D131F] p-5 sm:p-6 md:p-10 rounded-2xl sm:rounded-[2rem] border border-slate-800 hover:border-[#00D2FF]/60 shadow-[0_10px_35px_rgba(0,0,0,0.6)] hover:shadow-[0_15px_45px_rgba(0,210,255,0.2)] transition-all duration-500 flex flex-col"
              >
          ...
          <motion.div
            ...
            className="mt-12 sm:mt-16 md:mt-20 p-6 sm:p-10 md:p-12 bg-[#0D131F] border border-slate-800 rounded-2xl sm:rounded-[2rem] text-white text-center shadow-[0_15px_45px_rgba(0,0,0,0.8)] relative overflow-hidden"
          >
            <div className="relative z-10">
              <h2 className="text-2xl sm:text-3xl font-serif italic text-[#00D2FF] mb-4">Any Questions?</h2>
              <p className="text-slate-300 text-xs sm:text-sm font-light max-w-xl mx-auto mb-6 sm:mb-8">
                Visit our arena in Samayapuram, Trichy (1st Floor, Above KFC) or contact our team directly.
              </p>
              <Link 
                href="/contact"
                className="inline-block w-full sm:w-auto px-8 py-3.5 sm:py-4 bg-[#00D2FF] text-[#080C14] font-black text-xs uppercase tracking-[0.2em] rounded-full hover:bg-white transition-all shadow-[0_0_20px_rgba(0,210,255,0.6)] text-center"
              >
                Contact &amp; Location
              </Link>
            </div>
