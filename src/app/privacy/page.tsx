      ...
      <section className="px-6 md:px-12 py-20 max-w-5xl mx-auto relative z-10">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            {policies.map((policy, index) => (
              <motion.div
                ...
                className={cn(
                  "group bg-white p-6 md:p-10 rounded-[1.5rem] md:rounded-[2rem] border border-cream shadow-premium hover:shadow-[0_20px_50px_rgba(200,149,95,0.15)] transition-all duration-500 flex flex-col"
                )}
              >
                <div className="w-12 h-12 rounded-2xl bg-background flex items-center justify-center text-cappuccino mb-6 group-hover:bg-cappuccino group-hover:text-white transition-colors duration-500 shadow-sm shrink-0">
                  <policy.icon className="w-6 h-6" />
                </div>
                <h2 className="text-xl md:text-2xl font-serif italic text-coffee-dark mb-3 leading-tight">
                  {policy.title}
                </h2>
                <p className="text-xs md:text-sm text-coffee-dark/60 font-light leading-relaxed flex-grow">
                  {policy.content}
                </p>
              </motion.div>
            ))}
          ...
          <motion.div
            ...
            className="mt-20 p-10 md:p-12 bg-coffee-dark rounded-[2rem] text-white text-center shadow-premium relative overflow-hidden"
          >
            <div className="relative z-10">
              <h2 className="text-3xl font-serif italic text-cappuccino mb-4">Any Questions?</h2>
              ...
              <Link 
                href="/contact"
                className="inline-block px-8 py-4 bg-cappuccino text-coffee-dark font-bold text-[10px] uppercase tracking-[0.2em] rounded-full hover:bg-white transition-colors shadow-[0_0_20px_rgba(200,149,95,0.4)]"
              >
                Contact &amp; Location
              </Link>
            </div>
